...
if (isset($_GET['action']) && $_GET['action'] == 'clear') {
    if (file_exists(PROJECT_ROOT . '/uploads/data.csv')) {
        unlink(PROJECT_ROOT . '/uploads/data.csv');
    }
    header("Location: index.php?route=qr");
    exit;
}
    ...
    for ($i = 0; $i < $fileCount; $i++) {
        ...
        if ($error === 0) {
            ...
            if (move_uploaded_file($tmpName, $destPath)) {
                ...
                $pdfPath = PROJECT_ROOT . '/results/QR_' . pathinfo($safeName, PATHINFO_FILENAME) . '.pdf';
    ...
    <div class="container">
        ...
        <div class="main-content">
            <div class="upload-card">
                ...
                <form action="index.php?route=qr" method="post" enctype="multipart/form-data" id="uploadForm">
        ...
        <div class="sidebar">
            <div class="sidebar-header">
                ...
                <div style="display: flex; gap: 10px;">
                    <?php if($showSidebar && !empty($data)): ?>
                        <a href="index.php?route=qr&action=clear" class="btn-download" style="background-color: #e74c3c;" title="Clear All">
                    ...
                    ?>
                        <div class="file-section">
                            ...
                            <div class="file-header" onclick="toggleSection('section-<?= $sectionId ?>')">
                                ...
                                <a href="index.php?api=download&file=<?= urlencode($group['file']) ?>" target="_blank" onclick="event.stopPropagation();" style="font-size: 0.75rem; text-decoration: none; color: #fff; background-color: #27ae60; padding: 4px 8px; border-radius: 4px; display: flex; align-items: center; gap: 4px;">
